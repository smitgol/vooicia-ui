      ...
      <div className="container mx-auto py-1.5 px-6 flex flex-col justify-center gap-1 sm:gap-2">
        <div className={`flex items-center justify-between w-full`}>
          ...
          <Link href="/" className="flex items-center gap-2">
            <span className="bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent text-xl font-bold">
              Voycia
            </span>
          </Link>
          <button 
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Button className="ml-4 font-bold cursor-pointer hover:scale-105 transition delay-200 duration-300 ease-in-out rounded-4xl px-4 py-2" onClick={() => router.push("/#hero")}>
              Try Now
            </Button>
          </nav>
